...
module.exports = require("vue-animate-scroll");
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(5).default("f07c165a", content, true)
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "html{font-family:Poppins,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif;font-size:16px;word-spacing:1px;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;box-sizing:border-box}.VueCarousel-inner{display:flex;align-items:center}body{padding-top:0;overflow-x:hidden;overflow-y:auto}*,:after,:before{box-sizing:border-box;margin:0;line-height:1}button,input,textarea{font-family:Poppins}a,button{cursor:pointer}a,button,input,textarea{outline:none}", ""]);
// Exports
module.exports = exports;
...
const _3f85f308 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 99))); // TODO: remove in Nuxt 3
...
// EXTERNAL MODULE: ./static/css/bootstrap.css
var bootstrap = __webpack_require__(27);

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=00d09da4&
var defaultvue_type_template_id_00d09da4_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nuxt')}
var defaultvue_type_template_id_00d09da4_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=00d09da4&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  script,
  defaultvue_type_template_id_00d09da4_render,
  defaultvue_type_template_id_00d09da4_staticRenderFns,
  false,
...
var vue_fontawesome_ = __webpack_require__(2);

// CONCATENATED MODULE: ./.nuxt/templates.plugin.12c46eed.js
...
var free_brands_svg_icons_ = __webpack_require__(18);
...
fontawesome_svg_core_["library"].add(free_brands_svg_icons_["fab"]); // Register the component globally

external_vue_default.a.component("font-awesome-icon", vue_fontawesome_["FontAwesomeIcon"]);
// EXTERNAL MODULE: external "vue-animate-scroll"
var external_vue_animate_scroll_ = __webpack_require__(19);
var external_vue_animate_scroll_default = /*#__PURE__*/__webpack_require__.n(external_vue_animate_scroll_);

// CONCATENATED MODULE: ./plugins/vue-animate-scroll.js


external_vue_default.a.use(external_vue_animate_scroll_default.a);
// EXTERNAL MODULE: external "vue-scrollto"
var external_vue_scrollto_ = __webpack_require__(20);
...
/* Plugins */
 ...
 // Source: ./templates.plugin.12c46eed.js (mode: 'all')

 // Source: ../plugins/vue2-scrollspy (mode: 'client')

 // Source: ../plugins/vue-carousel (mode: 'client')

 // Source: ../plugins/fontawesome.js (mode: 'all')

 // Source: ../plugins/vue-animate-scroll.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {
      ...
      "meta": [{
        ...
        "hid": "description",
        "name": "description",
        "content": "Official Website Of @frontendjoe"
      }],
      "link": [{
        "rel": "icon",
        "type": "image\u002Fx-icon",
        ...
        "rel": "stylesheet",
        "href": "https:\u002F\u002Ffonts.googleapis.com\u002Fcss?family=Poppins:400,600,800,900&display=swap"
      }, {
        "rel": "stylesheet",
  ...
  if (typeof /* Cannot get final name for export "default" in "./.nuxt/templates.plugin.12c46eed.js" (known exports: , known reexports: ) */ undefined === 'function') {
    await /* Cannot get final name for export "default" in "./.nuxt/templates.plugin.12c46eed.js" (known exports: , known reexports: ) */ undefined(app.context, inject);
  }
  ...
  if (typeof /* Cannot get final name for export "default" in "./plugins/vue-animate-scroll.js" (known exports: , known reexports: ) */ undefined === 'function') {
    await /* Cannot get final name for export "default" in "./plugins/vue-animate-scroll.js" (known exports: , known reexports: ) */ undefined(app.context, inject);
  }
